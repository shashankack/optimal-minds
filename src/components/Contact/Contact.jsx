        ...
        <div className="contact-form-container" id="contact-form">
          ...
          <form className="contact-form">
            <div className="input-field">
              <input type="text" id="_name" className="field" required />
              <label for="_name">Name</label>
              <div className="field-focus" />
            </div>
            <div className="input-field">
              <input type="email" id="_email" className="field" required />
              <label for="_email">Email</label>
              <div className="field-focus" />
            </div>
            <div className="input-field">
              <input type="tel" id="_phone" className="field" required />
              <label for="_phone">Phone</label>
              <div className="field-focus" />
            </div>
            <div className="input-field">
              <input type="text" id="_message" className="field" required />
              <label for="_message">Your Message</label>
              <div className="field-focus" />
            </div>
